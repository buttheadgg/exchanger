          ...
          <div className={styles.container}>
            <div className={styles.header__innerFooterMain}>
              ...
              <nav className={styles.menu}>
                <ul className={styles.menu__listHeader}>
                  ...
                  <li className={styles.menu__listItem}>
                    <a href="#" className={styles.menu__listLink}>Sheepy
                    <div className={`${styles.menu__dropdownContent} ${styles.dropdown__sheepyBurger} ${styles.dropdown__sheepyFooter}`}>
                  ...
                  <li className={styles.menu__listItem}>
                    <a href="#" className="menu__list-link ">Company
                      <div className={`${styles.menu__dropdownContent} ${styles.dropdown__companyBurger} ${styles.dropdown__companyFooter}`}>
                          <div className={styles.menu__dropdownWrapper}>
                            <img src="./image/dropdown-iconImage.svg" alt=""  />
                            <a href="#">
                              <div className={styles.menu__dropdownTitle}>About us/Company</div>
            ...
            <div className={styles.header__innerFooterPhone}>
              <ul className={styles.menu_listFooter}>
                  <li className={styles.menu__listItem}>
                    <a href="#" className={`${styles.menu__listLink} ${styles.footer_listItem}`}>Products</a>
                  </li>
                  <li className={styles.menu__listItem}>
                    <a href="#" className={`${styles.menu__listLink} ${styles.footer_listItem}`}>Company</a>
                  </li>
                  <li className={styles.menu__listItem}>
                    <a href="#" className={`${styles.menu__listLink} ${styles.footer_listItem}`}>Road map</a>
                  </li>
                  <li className={styles.menu__listItem}>
                    <a href="#" className={`${styles.menu__listLink} ${styles.footer_listItem}`}>White papper</a>
                  </li>
                  <li className={styles.menu__listItem}>
                    <a href="#" className={`${styles.menu__listLink} ${styles.footer_listItem}`}>FAQ</a>
                  </li>
              </ul>
            </div>
          </div>
            ...
            <div className={styles.copy__nav}>
              <ul className={styles.copy__navList}>
                <li className={styles.copy__navItem}>
                  <a href="#" className={styles.copy__navLink}>© Copyright </a>
                </li>
                <span className={styles.copy__navPoint}></span>
                <li>
                  <a href="#" className={styles.copy__navLink}>Privacy policy</a>
                </li>
                <span className={styles.copy__navPoint}></span>
                <li className={styles.copy__navItem}>
                  <a href="#" className={styles.copy__navLink}>Terms of service</a>
                </li>
              </ul>
            </div>
            <div className={`${styles.light__box} ${styles.light__boxFooter}`}></div>
          </div>
      </footer>
    );
};
